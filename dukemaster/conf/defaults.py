"""
dukemaster.conf.defaults
~~~~~~~~~~~~~~~~~~~~~~~~

Note: These settings are largely taken from django sentry

Represents the default values for all Dukemaser settings.
...
WEB_HOST = 'localhost'
WEB_PORT = 9000
WEB_LOG_FILE = os.path.join(ROOT, 'dukemaster.log')
WEB_PID_FILE = os.path.join(ROOT, 'dukemaster.pid')
